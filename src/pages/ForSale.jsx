...
// Remove the Footer import if it's already included in a shared layout
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow container mx-auto py-8">
        <h2 className="text-2xl ml-4 font-bold mb-4 text-center">Buildings for Sale</h2>
      ...
      {/* Remove Footer component if it's already included in the shared layout */}
    </div>
  );
};
